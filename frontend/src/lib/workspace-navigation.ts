...
export type WorkspaceModuleId = "trustworthiness" | "okrs" | "okr-bot" | "portfolio-analysis" | "tw-bot";
...
export function getWorkspaceModuleFromPathname(pathname: string): WorkspaceModuleId | null {
  ...
  if (pathname.startsWith("/workspace/tw-bot")) {
    return "tw-bot";
  }
...
export function getWorkspaceModuleHref(moduleId: WorkspaceModuleId) {
  ...
  if (moduleId === "tw-bot") return "/workspace/tw-bot";
...
export function readWorkspaceModuleCookie(
  ...
  return value === "okrs" || value === "okr-bot" || value === "trustworthiness" || value === "portfolio-analysis" || value === "tw-bot"
    ? value
